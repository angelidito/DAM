...
public class Cliente extends com.matisse.reflect.MtObject {
    ...
    private static int CID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtClass.Loader("inmoriliaria.Cliente"));
    ...
    /** Attribute <code>idCliente</code> cache ID */
    private static int idClienteCID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtAttribute.Loader("idCliente",CID));

    /**
     * Gets the <code>idCliente</code> attribute descriptor.
     * This method supports advanced MATISSE programming techniques such as
     * dynamically modifying the schema.
     * @param db the database containing the attribute
     * @return the attribute descriptor object
     */
    public static com.matisse.reflect.MtAttribute getIdClienteAttribute(com.matisse.MtDatabase db) {
        return (com.matisse.reflect.MtAttribute)db.getCachedObject(idClienteCID);
    }


    /**
     * Gets the <code>idCliente</code> attribute value.
     * @return the value
     *
     * @see #setIdCliente
     * @see #removeIdCliente
    ...
    public final int getIdCliente() {
        return getInteger(getIdClienteAttribute(getMtDatabase()));
    }

    /**
     * Sets the <code>idCliente</code> attribute value.
     * @param val the new value
     *
     * @see #getIdCliente
     * @see #removeIdCliente
     */
    public final void setIdCliente(int val) {
        setInteger(getIdClienteAttribute(getMtDatabase()), val);
    }

    /**
     * Removes the current <code>idCliente</code> attribute value.
     ...
     * @see #setIdCliente
     */
    public final void removeIdCliente() {
        removeValue(getIdClienteAttribute(getMtDatabase()));
    }
     ...
     * @see #setIdCliente
     */
    public final boolean isIdClienteNull() {
        return isNull(getIdClienteAttribute(getMtDatabase()));
    }
     ...
     * @see #setIdCliente
     */
    public final boolean isIdClienteDefaultValue() {
        return isDefaultValue(getIdClienteAttribute(getMtDatabase()));
    }
    ...
    private static int quiereComprarCID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtRelationship.Loader("quiereComprar",CID));
     ...
     */
    public final inmoriliaria.Vivienda[] getQuiereComprar() {
        return (inmoriliaria.Vivienda[])getSuccessors(getQuiereComprarRelationship(getMtDatabase()), inmoriliaria.Vivienda.class);
    }
    ...
    /**
     * Opens an iterator on the <code>quiereComprar</code> relationship's successors.
    ...
    public final <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> quiereComprarIterator() {
        return this.<E>successorIterator(getQuiereComprarRelationship(getMtDatabase()), inmoriliaria.Vivienda.class);
    }
     ...
     * @see #removeQuiereComprar
     */
    public final void setQuiereComprar(inmoriliaria.Vivienda[] succs) {
        setSuccessors(getQuiereComprarRelationship(getMtDatabase()), succs);
    }

    /**
     * Inserts one object at the beginning of the existing <code>quiereComprar</code> successors list.
     ...
     * @see #removeQuiereComprar
     */
    public final void prependQuiereComprar(inmoriliaria.Vivienda succ) {
        prependSuccessor(getQuiereComprarRelationship(getMtDatabase()), succ);
    }

    /**
     * Adds one object to the end of the existing <code>quiereComprar</code> successors list.
     * @param succ the object to add
     *
     * @see #getQuiereComprar
     * @see #setQuiereComprar
     ...
     * @see #quiereComprarIterator
     */
    public final void appendQuiereComprar(inmoriliaria.Vivienda succ) {
        appendSuccessor(getQuiereComprarRelationship(getMtDatabase()), succ);
    }
    /** Adds multiple objects to the end of the existing <code>quiereComprar</code> successors list.
     ...
     * @see #quiereComprarIterator
     */
    public final void appendQuiereComprar(inmoriliaria.Vivienda[] succs) {
     ...
     * @see #quiereComprarIterator
     */
    public void removeQuiereComprar(inmoriliaria.Vivienda[] succs) {
     ...
     * @see #quiereComprarIterator
     */
    public void removeQuiereComprar(inmoriliaria.Vivienda succ) {
        removeSuccessor(getQuiereComprarRelationship(getMtDatabase()), succ);
    }

    /**
     * Removes all <code>quiereComprar</code> successors.  When the minimum cardinality
