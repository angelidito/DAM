 ...
 * Generation date: Wed Feb 09 13:22:46 2022
 */
...
public class Obra extends com.matisse.reflect.MtObject {
    ...
    private static int CID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtClass.Loader("RAMABD.Obra"));
     ...
     */
    public final RAMABD.Autor[] getEscrito_por() {
        return (RAMABD.Autor[])getSuccessors(getEscrito_porRelationship(getMtDatabase()), RAMABD.Autor.class);
    }
    ...
    public final <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> escrito_porIterator() {
        return this.<E>successorIterator(getEscrito_porRelationship(getMtDatabase()), RAMABD.Autor.class);
    }
     ...
     * @see #removeEscrito_por
     */
    public final void setEscrito_por(RAMABD.Autor[] succs) {
     ...
     * @see #removeEscrito_por
     */
    public final void prependEscrito_por(RAMABD.Autor succ) {
     ...
     * @see #escrito_porIterator
     */
    public final void appendEscrito_por(RAMABD.Autor succ) {
     ...
     * @see #escrito_porIterator
     */
    public final void appendEscrito_por(RAMABD.Autor[] succs) {
     ...
     * @see #escrito_porIterator
     */
    public void removeEscrito_por(RAMABD.Autor[] succs) {
     ...
     * @see #escrito_porIterator
     */
    public void removeEscrito_por(RAMABD.Autor succ) {
