 ...
 */
public class Articulo extends RAMABD.Obra {
    ...
    private static int CID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtClass.Loader("RAMABD.Articulo"));
