...
namespace CapaPresentacion
{
    public partial class frmProductos : Form
    {
        ...
        private void dgvdata_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvdata.Columns[e.ColumnIndex].Name == "btnSeleccionar")
            {
                ...
                if (indice >= 0)
                {
                    ...
                    {
                        if (Convert.ToInt32(oc.Valor) == Convert.ToInt32(dgvdata.Rows[indice].Cells["IdTipoPersona"].Value))
                        {
		...
		private void dgvdata_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
		{
            ...
            if (dgvdata.Columns[e.ColumnIndex].Name == "btnSeleccionar")
            {
                txtcodigo.Text = dgvdata.Rows[indice].Cells["Id"].Value.ToString();
                txtnombre.Text = dgvdata.Rows[indice].Cells["NombreCompleto"].Value.ToString();
                txtdescripcion.Text = dgvdata.Rows[indice].Cells["Descripcion"].Value.ToString();
                //cbocategoria.SelectedItem = dgvdata.Rows[indice].Cells["Categoria"].Value.ToString();
                //cboestado.SelectedItem = dgvdata.Rows[indice].Cells["Estado"].Value.ToString();

                cbocategoria.SelectedIndex= Convert.ToInt32(dgvdata.Rows[indice].Cells["IdCategoria"].Value);
