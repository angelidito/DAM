...
import com.sde.ej1delgadosergio.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val usuario4 = Usuario("Kylian10", "123")
        val usuario5 = Usuario("Vini Jr", "123")
        ...
        binding.btnAceptar.setOnClickListener {
            ...
            if(usuario.isEmpty() || pass.isEmpty()){
                ...
                // Si encuentra al usuario se avanza a la siguiente pestaña
                    ...
                    intent = Intent(this, ConsultaProductos::class.java)
