...
import com.vdv.tiendas.databinding.ItemStoreBinding

class AdaptadorTienda (private var tiendas:MutableList<Tienda>, private var listener:EventosListener)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        /*  holder.binding.cbFavorite.isChecked=tienda.esFavorito
            se utiliza el with para reducir codigo,
            si no deberiamos haber puesto holder en ambas lineas, como se muestra en la linea   */
    }
