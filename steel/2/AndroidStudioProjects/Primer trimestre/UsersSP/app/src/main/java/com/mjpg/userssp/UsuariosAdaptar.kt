...
class UsuariosAdaptar(private val usuarios: List<Usuario>, private val listener: EventosListener) :
    RecyclerView.Adapter<UsuariosAdaptar.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        with(holder){
            ...
            binding.tvOrder.text=usuario.id.toString()
            Glide.with(context)
                .load(usuario.url)
                .centerCrop()
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun  setListener(usuario: Usuario, position: Int){
            binding.root.setOnClickListener { listener.onClickListener(usuario,position) }
        }
    }
}